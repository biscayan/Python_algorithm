...
class Bellmanford:
    ...
    def getshortestpath(self, targetvertex):
        ...
        if not Bellmanford.has_cycle:
            print("Shortest path exists with values: ",targetvertex.mindistance)
...
if __name__=='__main__':
    ...
    bellmanford.calcshortestpath(vertexlist,edgelist,node1)
    bellmanford.getshortestpath(node7)
